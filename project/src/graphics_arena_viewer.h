...
class GraphicsArenaViewer : public mingfx::GraphicsApp, public ArenaViewer {
  ...
  */
  ...
  void OnUpdate(WheelVelocity wv1, WheelVelocity wv2, WheelVelocity wv3);
  // void OnUpdate(WheelVelocity* wv);
 ...
 private:
  ...
  GraphicsArenaViewer* observer{nullptr};
  BraitenbergVehicle* oldentity{nullptr};
};
